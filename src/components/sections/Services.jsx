import { HiCodeBracket, HiPaintBrush, HiDevicePhoneMobile, HiLightBulb } from 'react-icons/hi2'
    ...
    <Section id="services">
      <Container>
        <SectionHeading
          ...
          description="End-to-end solutions tailored to your unique needs and goals."
        />
